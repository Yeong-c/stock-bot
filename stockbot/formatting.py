...
def help_text() -> str:
    parts = ["❓ 사용법\n아래 버튼을 누르면 됩니다.",
             ...
             "🤖 AI 추천 — 검색식 여러 개에 같이 걸린 종목을 AI 가 최근 동향·공시로 평가해 상위 10개 (장 마감 후 자동)",
             "📰 오늘 뉴스 — 금리·환율·미국증시·지정학 등 오늘 시장에 영향 주는 뉴스 정리 (평일 08:20 자동)",
             "🔍 종목 분석 — '삼성전자 분석' 처럼 보내면 그 종목만 AI 가 분석. 이전 분석 기록과 비교해 줌",
             "",
             "📌 검색식 설명"]
